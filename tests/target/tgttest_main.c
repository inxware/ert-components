...
void EhsMainLoop(void)
{
	...
	if (nCurrentSuite == -1)
	{
		...
		case 'a':
			...
			TestsTried = 0;
			break;
		case '9': nCurrentSuite++;
		case '8': nCurrentSuite++;
		case '7': nCurrentSuite++;
		case '6': nCurrentSuite++;
		case '5': nCurrentSuite++;
		case '4': nCurrentSuite++;
		case '3': nCurrentSuite++;
		case '2': nCurrentSuite++;
		case '1': nCurrentSuite++;
		case '0': nCurrentSuite++;
