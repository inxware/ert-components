...
cp  -f ../DevmanSecurity/devman.ambifier.com/devman-ca-bundle.crt ../TARGET_TREES/ehs_env-$TARGET/devman/core/certs/devman-ca.crt
cp  -f ../DevmanSecurity/devman.ambifier.com/devman-client-crt-key.pem ../TARGET_TREES/ehs_env-$TARGET/devman/core/certs/devman-client-crt-key.pem
