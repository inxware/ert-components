...
#cp "$EHS_ROOT/../TARGET_TREES/ehs_env-${TARGET}/devman/core/certs/devman-ca.crt" "$TEMP_CERT_DIR/devman-ca.crt" || exit 1
cp "$EHS_ROOT/../TARGET_TREES/ehs_env-${TARGET}/devman/core/certs/devman-only-ca.crt" "$TEMP_CERT_DIR/devman-ca.crt" || exit 1
# Copy the 
cp "$EHS_ROOT/../TARGET_TREES/ehs_env-${TARGET}/devman/core/certs/devman-client-crt-key.pem" "$TEMP_CERT_DIR/devman-client-crt-key.pem" || exit 1
cp "$EHS_ROOT/../TARGET_TREES/ehs_env-${TARGET}/devman/core/certs/devman-client-crt-key.p12" "$TEMP_CERT_DIR/devman-client-crt-key.p12" || exit 1
