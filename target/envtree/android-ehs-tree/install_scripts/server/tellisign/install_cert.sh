...
cp "$EHS_ROOT/../DevmanSecurity/$URL/devman-ca.crt" "$TEMP_CERT_DIR/devman-ca.crt" || exit 1
cp "$EHS_ROOT/../DevmanSecurity/$URL/devman-client-crt-key.pem" "$TEMP_CERT_DIR/devman-client-crt-key.pem" || exit 1
