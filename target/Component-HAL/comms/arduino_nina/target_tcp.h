...
typedef struct sock_dummy EhsTgtTcpSockAddrInType;

typedef struct sock_dummy EhsTgtTcpSockAddrInTypeWindows; /*todo rename these */

typedef struct sock_dummy EhsTgtTcpSockAddrType;
