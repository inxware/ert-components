...
/* Generic LoRaWAN module API, wio_e5 flavour.
 * lorawan.c and every module implementation (wio_e5, stubbed, rak3112, ...)
 * use this header so the top-level dispatch is module-agnostic. The actual
 * symbols are provided by the module subdirectory selected via
 * EHS_LORAWAN_SUPPORT in the platform config.mk. */
