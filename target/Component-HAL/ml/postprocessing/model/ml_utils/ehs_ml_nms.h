#ifndef _C_HEADER_EHS_TARGET_HAL_ML_MODEL_ML_UTILS_EHS_ML_NMS_H
#define _C_HEADER_EHS_TARGET_HAL_ML_MODEL_ML_UTILS_EHS_ML_NMS_H
...
/* Box is [x_center, y_center, width, height, rotation angle in radians] */
typedef struct {
    double x, y, w, h, angle_rad;
    double score;      /* confidence (objectness * class prob) */
    int   class_id;   /* ≥0 */
} NMSBox;
 ...
 * -------------------------------------------------------------------------- */
size_t EhsApply_Greedy_NMS(const NMSBox* in_boxes,
                  size_t        N,
                  float         conf_thr,
                  float         iou_thr,
                  int           class_aware,
...
#endif /* _C_HEADER_EHS_TARGET_HAL_ML_MODEL_ML_UTILS_EHS_ML_NMS_H */
