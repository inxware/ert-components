...
/**
 * Perform necessary Operating system setup upon system initialisation - early call
 */
EHS_GLOBAL void EhsTGfxSys_init();

/**
 * Perform necessary Operating system setup upon system initialisation - late call
 */
EHS_GLOBAL void EhsTGfxSys_initLate();
