...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x3, 0x77, 0x77, 0x77, 0x8a, 0xff, 0xf2, 0x0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 26134, .adv_w = 288, .box_w = 18, .box_h = 24, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 26350, .adv_w = 386, .box_w = 25, .box_h = 16, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 26550, .adv_w = 384, .box_w = 24, .box_h = 25, .ofs_x = -1, .ofs_y = -5}
};
