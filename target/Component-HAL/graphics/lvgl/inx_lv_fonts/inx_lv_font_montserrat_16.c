...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xf9, 0xce, 0x16, 0x40, 0x0, 0x0, 0x0, 0xef,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 12077, .adv_w = 192, .box_w = 12, .box_h = 16, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 12173, .adv_w = 258, .box_w = 17, .box_h = 11, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 12267, .adv_w = 256, .box_w = 16, .box_h = 17, .ofs_x = 0, .ofs_y = -4}
};
