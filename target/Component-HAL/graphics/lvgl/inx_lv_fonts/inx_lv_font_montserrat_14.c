...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    /* U+F127 "" */
    0x2, 0x0, 0x0, 0x0, 0x3, 0x20, 0x0, 0xaf,
    ...
    0x4f, 0xfe, 0xf2, 0xfc, 0x3f, 0xd8, 0xfe, 0xff,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 9649, .adv_w = 168, .box_w = 11, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 9732, .adv_w = 225, .box_w = 15, .box_h = 10, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 9807, .adv_w = 224, .box_w = 14, .box_h = 15, .ofs_x = 0, .ofs_y = -3}
};
