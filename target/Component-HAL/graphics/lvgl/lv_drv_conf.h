...
#if TARGET_LVGL_USE_COMMON_DRIVER == 1 /*Set it to "1" to enable the content*/
...
#  define SDL_HOR_RES     TARGET_LVGL_HORIZONTAL
#  define SDL_VER_RES     TARGET_LVGL_VERTICAL
...
#if USE_MONITOR
#  define MONITOR_HOR_RES     TARGET_LVGL_HORIZONTAL
#  define MONITOR_VER_RES     TARGET_LVGL_VERTICAL
...
#if USE_WINDOWS
#  define WINDOW_HOR_RES      TARGET_LVGL_HORIZONTAL
#  define WINDOW_VER_RES      TARGET_LVGL_VERTICAL
#endif
...
#    define EVDEV_HOR_MAX      TARGET_LVGL_HORIZONTAL               /*"evtest" Linux tool can help to get the correct calibraion values>*/
#    define EVDEV_VER_MIN         0
#    define EVDEV_VER_MAX      TARGET_LVGL_VERTICAL
