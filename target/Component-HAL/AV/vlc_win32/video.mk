...
#INC_DIRS += $(EHS_TARGET_VIDEO_PATH)/../../../../vlc_source/include
#INC_DIRS += $(EHS_TARGET_VIDEO_PATH)/../../../../vlc_source/include/src

# include sourcecode from this dir in build
include $(EHS_TARGET_AV_PATH)/../vlc_common/video.mk


OBJECTS += libvlc_dll.$(OBJ)
