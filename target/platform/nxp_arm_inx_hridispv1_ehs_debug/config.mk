...
#todo2024 - we shouldn't need the following if we set EHS_NXP_SUPPORT=yes in the os-arch config??
EHS_NXP_SUPPORT=yes
DEFS += EHS_NXP_SUPPORT=1
DEFS += EHS_LWIP=1

#These are sub  product type build conditions so hapy to eave these as DEFS+= 
...
DEFS += INX_HEATROD_IOT_DIAGNOSTIC_BUILD
