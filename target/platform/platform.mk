...
# The EHS kernel is pre-compiled by the EHS-kernel repo and installed to
# ert-build-support as libehs_ehrt1.a (or libehs.a for SODL v0). No kernel source
# is compiled here — EHS_COMMON_KAPI_PATH (already in INC_DIRS) supplies the
# kernel headers, and it lives in this repo, so no EHS-kernel checkout is needed
# to build ert-components.
