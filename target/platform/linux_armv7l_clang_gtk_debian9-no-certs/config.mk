...
# @file config.mk
# inxware ERT configuration for linux_armv7l_clang_gtk_debian9-no-certs
#
# Community-release variant of linux_armv7l_clang_gtk_debian9.
#
...
include ./target/platform/linux_armv7l_clang_gtk_debian9/config.mk
