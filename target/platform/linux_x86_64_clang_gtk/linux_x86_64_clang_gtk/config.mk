...
# @file config.mk 
# inxware ERT configuration file for linux_x86_64_clang_gtk
# @author: inx limited

#================================================================================================================
# THis is the basis of 64 bit clang build needed for greengrass,
# which doesn't currently build!
#================================================================================================================
...
#This is the contribu build path for components x86_64-linux-gnu-clang10_clang10_base
...
#COMPONENT_VARIANT=aws-iot # todo2022 waht is this in terms of middlewre paths (does it exist?)
...
#todo2022 - if this isn't set but AV is then we get some build problems. Need to orthogonalise.
EHS_MEDIA_SUPPORT=all

EHS_PERIPHERAL_DEVICE_SUPPORT=all

#Not working yet - create a new target for greengrasss
