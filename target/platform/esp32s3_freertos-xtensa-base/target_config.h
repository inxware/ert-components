...
/* Overrides go here */
#define EHS_CONFIG_DISPLAY_HEIGHT (480 - 1) /**< Height for the OSD part of the display */
#define EHS_CONFIG_DISPLAY_WIDTH (800 - 1) /**< Width for the OSD part of the display */
