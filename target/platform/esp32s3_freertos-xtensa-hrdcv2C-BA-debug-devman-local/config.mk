...
# @file config.mk
# inxware ERT configuration file for esp32s3_freertos-xtensa-hrdcv2C-BA-debug-devman-local
# @author: inx limited

# This is for the intermediate 2C boards that have Original display board but driven by 2C processor board.
# This uses a thinned down HRDC app that doesn't use Modbus to allow for cleaner updates.
...
# HRDCV2 product config ("3" for Rev. C - mainly affects GPIO mappings)
...
# Devman disabled for local development
...
#EHS_DEFAULT_APP=hardware-test-apps/HRDC2C-calibration
...
# TODO2025-URGENT: This should be somewhere sensible for all ESP32 builds
