...
# @file config.mk
# inxware ERT configuration file for esp32s3_freertos-xtensa-hrdcv2C-BA-debug
# @author: inx limited
...
# Serial console support (TEMPORARY - set to none for production)
SERIAL_CONSOLE_SUPPORT=yes
...
EHS_I2C_SUPPORT=yes
EHS_RTC_SUPPORT=yes
# RTC chip on HRDCv2C board (TODO make a proper config for this or just put it in target_config.h)
...
# TODO all these below should be moved to target_config.h
