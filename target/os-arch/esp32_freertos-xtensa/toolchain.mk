...
CFLAGS+= -DESP_PLATFORM -D IDF_VER=\"v4.4.1\" -MMD -MP 
#CFLAGS+= -D_GNU_SOURCE 
...
LNKFLAGS+= -lulp -lunity -lvfs -lwear_levelling -lwifi_provisioning -lwpa_supplicant -lxtensa -lhal -Wl,--end-group -Wl,-EL -fno-rtti
LIB+=c
LIB+=cxx
