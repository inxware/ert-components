...
ifndef AS_OVERRIDE
   AS_OVERRIDE:=xtensa-esp32-elf-as
endif
...
CFLAGS+= -DESP_PLATFORM -DIDF_VER=\"v4.4.1\" -MMD -MP -fshort-enums
#CFLAGS+= -D_GNU_SOURCE 
