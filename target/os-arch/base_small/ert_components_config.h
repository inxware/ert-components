...
#ifndef ERT_COMPONENTS_SMALL_CONFIG_H
#define ERT_COMPONENTS_SMALL_CONFIG_H
...
/* EHS_MAX_TOOLKITS is no longer defined here - the toolkit table's length is
 * EHS_TOOLKIT_TABLE_SLOTS in Common/KAPI/blockref_table.h, the single shared
 * definition. See the fuller note in ../base_full/ert_components_config.h. */

#ifndef EHS_MAX_WIDGET_INSTANCES
#define EHS_MAX_WIDGET_INSTANCES 120 /**< Defines the maximum number of widgets that are supported */
#endif
