...
status_t FLASH_Swap(flash_config_t *config, uint32_t address, bool isSetEnable)
{
    ...
    if (returnCode != kStatus_FTFx_Success)
    {
        HW_DIAG_printf("Address range is invalid\n");
    	return returnCode;
    }
    ...
    do
    {
        ...
        if (returnCode != kStatus_FTFx_Success)
        {
        	HW_DIAG_printf("Swap Control Failed\n");
        	return returnCode;
        }
        ...
        if (!isSetEnable)
        {
            ...
            {
            	HW_DIAG_printf("SwapState Is Disabled\n");
            	return kStatus_FTFx_Success;
            }
            else if (returnInfo.flashSwapState == kFTFx_SwapStateUninitialized)
            {
            	...
            	HW_DIAG_printf("SkFTFx_SwapStateUninitialized\n");
            ...
            else
            {
            	...
            	HW_DIAG_printf("NOT SkFTFx_SwapStateUninitialized\n");
        ...
        else
        {
             ...
             * After the first swap has been completed, the flash swap indicator address cannot be modified
            ...
            switch (returnInfo.flashSwapState)
            {
                case kFTFx_SwapStateUninitialized:
                	HW_DIAG_printf("flashSwapState=FTFx_SwapStateUninitialized  \n ");
                ...
                case kFTFx_SwapStateReady:
                	HW_DIAG_printf("flashSwapState= kFTFx_SwapStateReady \n ");
                    ...
                    if (returnCode == kStatus_FTFx_Success)
                    {
                    	...
                    	HW_DIAG_printf("lash_validate_swap_indicator_address - GOOD\n");
                        returnCode =
                            FTFx_CMD_SwapControl(ftfxConfig, address, kFTFx_SwapControlOptionSetInUpdateState, &returnInfo);
                    } else {
                    	HW_DIAG_printf("lash_validate_swap_indicator_address - BAD\n");
                    }
                    break;
                case kFTFx_SwapStateUpdate:
                	HW_DIAG_printf("flashSwapState= kFTFx_SwapStateUpdate \n ");
                ...
                case kFTFx_SwapStateUpdateErased:
                	HW_DIAG_printf("flashSwapState= kFTFx_SwapStateUpdateErased \n ");
                ...
                case kFTFx_SwapStateComplete:
                	HW_DIAG_printf("flashSwapState= kFTFx_SwapStateComplete \n ");
                    break;
                case kFTFx_SwapStateDisabled:
                	HW_DIAG_printf("flashSwapState= kFTFx_SwapStateDisabled \n ");
                    ...
                    break;
                default:
                	HW_DIAG_printf("flashSwapState= kStatus_FTFx_InvalidArgument \n ");
