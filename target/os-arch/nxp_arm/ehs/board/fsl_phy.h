...
#if CONFIG_TLK106
#define PHY_CONTROL1_REG 0x09U //tlk106 cr1
#define PHY_CONTROL2_REG 0x0AU //tlk106 cr2
#define PHY_TXCPSR_REG   0x42U  //TX Clock delay shifting
#define PHY_PHYCR_REG    0x19U  // Basic Phy config and status
#define PHY_CONTROL_ID1 8192 //id1 of the tlk106
#define PHY_BCTL_AUTONEG_MASK 0x1000U
#define PHY_BCTL_SPEED_MASK 0x2000U
#define PHY_BCTL_DUPLEX_MASK 0x80U
#define PHY_LINK_READY_MASK 0x4U
#define PHY_BCTL_AUTONEG_COMPLETE_MASK 0x20U
#define PHY_BCTL_RESTART_AUTONEG_MASK 0x200U
#else
