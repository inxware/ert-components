...
//PBB dropping this down to be the same as the HTTP stack size seemed to work fine
//#define HTTPSRV_CFG_HTTPS_SESSION_STACK_SIZE (4000 / sizeof(uint32_t))
#endif
...
#define HTTPSRV_CFG_SES_BUFFER_SIZE (1600)
...
#define HTTPSRV_CFG_DEFAULT_URL_LEN (1600)
...
//PBB setting this to 1 seems to cause hardware faults
...
#define HTTPSRV_CFG_SES_TIMEOUT (10000)
#endif
