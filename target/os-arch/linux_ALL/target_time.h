...
/* @TODO if you change the following the time wrap around will break and timers will become dead after a while! - Look into if changing this can reduce processing*/
#define EHS_TICKS_PER_S (1000000u) /**< Defines the resolution of the system clock in Hz */
#define EHS_uS_PER_TICK (1u)

/**
 * Defines the maximum value for EhsTickType. In this target, we reserve the top bit in order
 * to allow EHS_TICKTYPE_INVALID to have a distinct value
 */
#define EHS_TICKTYPE_MAX        0x7fffffffu
#define EHS_TICKTYPE_INVALID    0xffffffffu /**< Used as a rogue value for time functions */
 ...
 * @p
 * Given these assumptions, we can implement our opeEHS_TIME_srations as follows:
