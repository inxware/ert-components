...
#endif //if defined(EHS_GUI_SUPPORT) && defined(EHS_PERIPHERAL_DEVICE_SUPPORT)
        }
        else
        {
...
void    ShowSplashScreen(struct android_app* state)
{
    ...
    (*vm)->AttachCurrentThread(vm,&env, NULL);
     ...
     // LOGE("SPASHOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO");
