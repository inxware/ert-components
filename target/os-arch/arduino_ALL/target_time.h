...
#ifndef EHS_ARDUINO_MBEDNANO_TICKS_PER_S
#define EHS_ARDUINO_MBEDNANO_TICKS_PER_S 133000000
#endif//EHS_ARDUINO_MBEDNANO_TICKS_PER_S
#define EHS_TICKS_PER_EHS_FREERTOS_TICK (EHS_TICKS_PER_S / EHS_ARDUINO_MBEDNANO_TICKS_PER_S)
