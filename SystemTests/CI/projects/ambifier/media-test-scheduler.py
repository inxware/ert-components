...
if __name__ == "__main__":
    ...
    if version == 'Server':
        ...
        test_address = './media-test-scheduler-recorded.wav'
        ...
        model_address = './newmodel8k_4_tones_2.wav'
        ...
        for index, tone in enumerate(TestLUT):  #tone = sub-array
            ...
            if (len(timesTesting[0]) > 0 ) :
                ...
                if (start_index == 0):
                    ...
                    testCase1.systemout="white noise detected"
                elif (average_test_value > threshold_value):
                    stat= "fail"
                    #print (tone[3], stat)
                    npTestLUT[index][4] = average_test_value
                    test_results_list[index] = {}
