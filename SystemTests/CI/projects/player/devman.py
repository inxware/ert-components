...
class Devman:
    ...
    def setDevicePlaylist(self,deviceId, playlistId):
        url=self.baseUrl+'/api/mediaDashboard.php'
        response = requests.post(url,json={deviceId:playlistId,'token':self.apiToken})
        return response.json()
