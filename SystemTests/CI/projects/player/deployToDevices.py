...
if __name__ == "__main__":
	...
	deviceIds=devmanApi.getDeviceIds('ci_android_a6_testing')
	for deviceId in deviceIds['deviceIds']:
		...
		#No idea what the point of th e-ci version is now...
		devmanApi.startOSUpdate(deviceId,'update-android-pine64_a6-player-ci')
		testCase=TestCase()
