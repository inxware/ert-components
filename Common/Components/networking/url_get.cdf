<?xml version="1.0" encoding="UTF-8"?><Component>
	...
	<Parameters>
		...
		<Parameter>
			...
			<Description>Forces the POST method using the URL string</Description>
		...
		<Parameter>
			<Name>Path Levels to Remove</Name>
			<DataType>I</DataType>
			<DefaultValue>0</DefaultValue>
			<MinValue>0</MinValue>
		...
		<Parameter>
			...
			<Description>Duty gap allows a pause in ms to be inserted between each data chunk to reduce network flooding issues.</Description>
		...
		<Parameter>
			<Name>Cert Paths Host &amp; Client</Name>
			<DataType>I</DataType>
			<DefaultValue>0</DefaultValue>
			<MinValue>0</MinValue>
			<MaxValue>5</MaxValue>
			<Description>Locations@ 0: Operating System, 1:user/, 2:user-app, 3:devman/certs 4: system/, 5:apps/</Description>
		...
		<Parameter>
			<Name>Client SSL Cert Password</Name>
			<DataType>S</DataType>
            <DefaultValue/>
			<MinValue>0</MinValue>
			<MaxValue>0</MaxValue>
		...
		<Parameter>
			<Name>Overwrite Local File</Name>
			<DataType>B</DataType>
			<DefaultValue>1</DefaultValue>
