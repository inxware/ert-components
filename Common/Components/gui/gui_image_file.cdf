...
<Component>
  ...
  <Menu>User Interface
    <Menu>Graphics
      <Menu>Widgets
        <Menu>image display</Menu>
      </Menu>
    </Menu>
  </Menu>
  <LongDescription>Displays an image based on a filename. Use create to load new filenames dynamically.</LongDescription>
  <Parameter>
  ...
  <Port>
    ...
    <AtomicFlag>0</AtomicFlag>
    <FunctionName argument="0">load</FunctionName>
  </Port>
  <Port>
    <DataType>S</DataType>
    ...
    <FunctionName argument="1">load</FunctionName>
  </Port>
  <Port>
  ...
  <Port>
    ...
    <YCoordinate>35</YCoordinate>
    <AtomicFlag>0</AtomicFlag>
    <FunctionName argument="2">load</FunctionName>
  </Port>
  <Port>
    <Description>--</Description>
    <PortType>FinishPort</PortType>
