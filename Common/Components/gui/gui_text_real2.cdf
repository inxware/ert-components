<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <CDFInfo>
        ...
        <UpdatedDate>2023-09-22T11:57:10Z</UpdatedDate>
    </CDFInfo>
    <Description>
        <ShortDescription/>
        <LongDescription>This widget displays an floating point number to the GUI output. It can also be configured as Slider, Progress Bar or Gauge via iGB.</LongDescription>
        <UserName/>
        <Menu>
            User Interface
            <Menu>
                Graphics
                <Menu>Floating Point</Menu>
            </Menu>
        </Menu>
    </Description>
    <Block>
    ...
    <Hashes>
        <NameHash_CRC16>0x5149</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>c5d9de35</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
        ...
        <Parameter>
            <Name>Number of decimal places</Name>
            <DataType>I</DataType>
