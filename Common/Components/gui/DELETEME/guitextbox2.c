...
EHS_LOCAL void Ehs_gui_text2_update(EhsWidgetClass* pWidget, ehs_bool bAlphaConnected, EhsDataflowIntType nAlpha,
...
EHS_LOCAL void Ehs_gui_text2_write(EhsWidgetClass* pWidget, const ehs_char* szString);
...
#define EHS_FB_GUI_TEXT_IN_VALUE 0  /**< Function block input for value to display */
...
EHS_FB_INIT_FUNCTION(gui_widget)
{
    ...
    ehs_bool bRet = EHS_TRUE; /* assume initialisation fails */
 ...
 *
 */
void Ehs_gui_text2_update(EhsWidgetClass* pWidget, ehs_bool bAlphaConnected, EhsDataflowIntType nAlpha,
                          ehs_bool bXConnected, EhsDataflowIntType nXoffset,
                          ehs_bool bYConnected, EhsDataflowIntType nYoffset,
                          ehs_bool bWConnected, EhsDataflowIntType nWoffset,
                          ehs_bool bHConnected, EhsDataflowIntType nHoffset)
...
/**
 * Update the textbox string using text input (where these are connected)
 */
EHS_FB_RUN_FUNCTION(gui_text_string2_data)
{
    ...
    if(EHS_FB_IN_CONNECTED(EHS_FB_GUI_TEXT_IN_VALUE)){
...
//#ifdef EHS_TARGET_FP_SUPPORT
/**
 * Update the textbox float using float input (where these are connected)
 */
...
/**
 * Update the textbox Int using int input (where these are connected)
 */
...
/**
 * Update the textbox bool using bool input (where these are connected)
 */
