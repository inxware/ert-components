...
EHS_FB_INIT_FUNCTION(gui_patch)
{
    ...
    ehs_bool bRet = EHS_TRUE; /* assume initialisation succeds */
    ...
    return bRet; /* initialisation always succeeds so we don't crash out other functionality cos the UI isn't working */
}
