<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <Description>
        <ShortDescription>Bind a boolean property on a UI object</ShortDescription>
        <LongDescription>Provides bidirectional access to a boolean property on a UI object. The set port pushes the input value to the named property; the changed callback fires when the property changes externally (e.g. via user interaction in the UI), emitting the new value on value_out.</LongDescription>
        <UserName/>
        <Menu>User Interface
                <Menu>Bindings
                    <Menu>Boolean</Menu></Menu></Menu>
    </Description>
    <Block>
        <Type>IO</Type>
        <Width>130</Width>
    ...
    <FBID>
        <ERT1_ID>1</ERT1_ID>
        <Class>ui_data_bool</Class>
    </FBID>
    <Hashes>
        <NameHash_CRC16>0xBA59</NameHash_CRC16>
    ...
    <Parameters>
        ...
        <Parameter>
            ...
            <MinValue>0</MinValue>
            <MaxValue>0</MaxValue>
            <Description>Name of the boolean property on the UI object to read and write.</Description>
