...
EHS_FB_FUNCTION_ENTRY("create", gui_patch_create)
EHS_FB_FUNCTION_ENTRY("destroy", gui_patch_destroy)
EHS_FB_FUNCTION_ENTRY("show", gui_patch_show)
EHS_FB_FUNCTION_ENTRY("hide", gui_patch_hide)
EHS_FB_FUNCTION_ENTRY("update", gui_patch_update)
