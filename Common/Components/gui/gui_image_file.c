...
EHS_FB_FUNCTIONS_START(GUI_ImageFile)

EHS_FB_FUNCTION_ENTRY("create", 0x00 , GUI_ImageFile_create)

EHS_FB_FUNCTION_ENTRY("destroy", 0X01, GUI_ImageFile_destroy)

EHS_FB_FUNCTION_ENTRY("load", 0X02, GUI_ImageFile_load)

EHS_FB_FUNCTION_ENTRY("show", 0X03, GUI_ImageFile_show)

EHS_FB_FUNCTION_ENTRY("hide", 0X04, GUI_ImageFile_hide)

EHS_FB_FUNCTION_ENTRY("update", 0X05, GUI_ImageFile_update)
 ...
 */
EHS_FB_IDENTIFY_FUNCTION(GUI_ImageFile)
{
    EHS_TRACE_FUNCTION(EHS_FB_IDENTIFY_NAME(GUI_ImageFile));
 ...
 */
EHS_FB_INIT_FUNCTION(GUI_ImageFile)
{
 ...
 */
EHS_FB_RUN_FUNCTION(GUI_ImageFile_create)
{
    EhsWidgetClass *pWidget = *(EhsWidgetClass**)EHS_FB_RUN_CONTEXT;
    EHS_TRACE_FUNCTION(EHS_FB_RUN_NAME(GUI_ImageFile_create));
 ...
 * if it's visible.
 */
EHS_FB_RUN_FUNCTION(GUI_ImageFile_destroy)
{
    EhsWidgetClass *pWidget = *(EhsWidgetClass**)EHS_FB_RUN_CONTEXT;

    EHS_TRACE_FUNCTION(EHS_FB_RUN_NAME(GUI_ImageFile_destroy));
 ...
 */
EHS_FB_RUN_FUNCTION(GUI_ImageFile_load)
{
    EhsFunctionInstanceDataType *iBeforeVal;
    EhsWidgetClass *pWidget = *(EhsWidgetClass**)EHS_FB_RUN_CONTEXT;
    EHS_TRACE_FUNCTION(EHS_FB_RUN_NAME(GUI_ImageFile_load));
 ...
 */
EHS_FB_RUN_FUNCTION(GUI_ImageFile_show)
{
    EhsWidgetClass *pWidget = *(EhsWidgetClass**)EHS_FB_RUN_CONTEXT;
    EHS_TRACE_FUNCTION(EHS_FB_RUN_NAME(GUI_ImageFile_show));
 ...
 */
EHS_FB_RUN_FUNCTION(GUI_ImageFile_hide)
{
    EhsWidgetClass *pWidget = *(EhsWidgetClass**)EHS_FB_RUN_CONTEXT;
    EHS_TRACE_FUNCTION(EHS_FB_RUN_NAME(GUI_ImageFile_hide));
 ...
 */
EHS_FB_RUN_FUNCTION(GUI_ImageFile_update)
{
    EhsWidgetClass *pWidget = *(EhsWidgetClass**)EHS_FB_RUN_CONTEXT;
    ...
    EHS_TRACE_FUNCTION(EHS_FB_RUN_NAME(GUI_ImageFile_update));
