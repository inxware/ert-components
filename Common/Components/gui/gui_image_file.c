...
EHS_FB_FUNCTION_ENTRY("create", GUI_ImageFile_create)
EHS_FB_FUNCTION_ENTRY("destroy", GUI_ImageFile_destroy)
EHS_FB_FUNCTION_ENTRY("load", GUI_ImageFile_load)
EHS_FB_FUNCTION_ENTRY("show", GUI_ImageFile_show)
EHS_FB_FUNCTION_ENTRY("hide", GUI_ImageFile_hide)
EHS_FB_FUNCTION_ENTRY("update", GUI_ImageFile_update)
