...
EHS_GLOBAL EHS_FB_IDENTIFY_FUNCTION(ui_chart); // this relates to C file identify function
EHS_GLOBAL EHS_FB_INIT_FUNCTION(ui_chart); // this relates to C-file init function
EHS_GLOBAL EHS_FB_DESTROY_FUNCTION(ui_chart); //this relates to C-file destroy function
EHS_GLOBAL EHS_FB_RUN_FUNCTION(ui_chart_create); //a function executed by a start port
EHS_GLOBAL EHS_FB_RUN_FUNCTION(ui_chart_destroy); //a function executed by a start port
