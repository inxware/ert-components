<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <CDFInfo>
        ...
        <UpdatedDate>2023-09-22T11:58:03Z</UpdatedDate>
    </CDFInfo>
    <Description>
        <ShortDescription/>
        <LongDescription>This widget displays an boolean to the GUI output. It can also be configured as Button, Toggle or Check Box via iGB.</LongDescription>
        <UserName/>
        <Menu>
            User Interface
            <Menu>
    ...
    <FBID>
        <ERT1_ID>1</ERT1_ID>
        <Class>gui_text_bool2</Class>
    </FBID>
    <Hashes>
        <NameHash_CRC16>0x89EA</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>86e20f2</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
