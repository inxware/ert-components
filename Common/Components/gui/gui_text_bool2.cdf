...
<Component>
  ...
  <Menu>User Interface
    <Menu>Graphics
      <Menu>Widgets
        <Menu>bool display</Menu>
      </Menu>
    </Menu>
  </Menu>
  <LongDescription>This widget displays an boolean to the GUI output - currently as o or 1! (to save you converting to a string!).</LongDescription>
  <Parameter>
