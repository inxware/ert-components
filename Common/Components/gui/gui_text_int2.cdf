<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <CDFInfo>
        ...
        <UpdatedDate>2023-09-22T11:57:33Z</UpdatedDate>
    </CDFInfo>
    <Description>
        <ShortDescription/>
        <LongDescription>This widget displays an integer to the GUI output. It can also be configured as Slider, Progress Bar or Gauge via iGB.</LongDescription>
        <UserName/>
        <Menu>
            User Interface
            <Menu>
    ...
    <FBID>
        <ERT1_ID>1</ERT1_ID>
        <Class>gui_text_int2</Class>
    </FBID>
    <Hashes>
        <NameHash_CRC16>0x4709</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>5f9414df</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
