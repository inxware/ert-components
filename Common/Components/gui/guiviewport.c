...
EHS_FB_FUNCTION_ENTRY("create", gui_viewport_create)
EHS_FB_FUNCTION_ENTRY("destroy", gui_viewport_destroy)
EHS_FB_FUNCTION_ENTRY("show", gui_viewport_show)
EHS_FB_FUNCTION_ENTRY("hide", gui_viewport_hide)
EHS_FB_FUNCTION_ENTRY("update", gui_viewport_update)
...
EHS_FB_INIT_FUNCTION(gui_viewport)
{
	...
	*(EhsWidgetClass**)EHS_FB_RUN_CONTEXT =	EhsWidgetViewport_init(&xParams.xRect, xParams.nZorder, xParams.uClass.xPatch);//@todo this should be params
	...
	//printf("B w=%d,h=%d, relative=%d: in_w=%d, in_h=%d\n",nScreenWidth, nScreenHeight,bRelative,pWidget->xOrigRect.nWidth,pWidget->xOrigRect.nHeight);
	//printf("\nCoords  are XYWH: %d,%d,%d,%d\n",xParams.xRect.nLeft,xParams.xRect.nTop,xParams.xRect.nHeight,xParams.xRect.nWidth);
	//printf("\nACOLOURS are RGBA: %d,%d,%d,%d\n",xParams.uClass.xPatch.sComp.nRed,xParams.uClass.xPatch.sComp.nGreen,xParams.uClass.xPatch.sComp.nBlue,xParams.uClass.xPatch.sComp.nAlpha);
	//printf("\nBCOLOURS are RGBA: %d,%d,%d,%d\n",pWidget->specific.patch.xColour.sComp.nRed,pWidget->specific.patch.xColour.sComp.nGreen,pWidget->specific.patch.xColour.sComp.nBlue,pWidget->specific.patch.xColour.sComp.nAlpha);
