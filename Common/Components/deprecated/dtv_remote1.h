...
EHS_COMPONENT_API_EXPORT EHS_FB_IDENTIFY_FUNCTION(DtvRemote1);
EHS_COMPONENT_API_EXPORT EHS_FB_INIT_FUNCTION(DtvRemote1);
EHS_COMPONENT_API_EXPORT EHS_FB_RUN_FUNCTION(DtvRemote1);
