<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <Hashes>
        <NameHash_CRC16>0xAC48</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>7054a8ec</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
    ...
    <Functions>
        <Function>
            <name>CreateGUI_WriteTextBoxInt</name>
            <ID>
                <ERT1_ID>1</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>DestroyGUI_WriteTextBoxInt</name>
            <ID>
                <ERT1_ID>2</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>RunGUI_WriteTextBoxInt</name>
            <ID>
                <ERT1_ID>3</ERT1_ID>
            </ID>
        </Function>
