...
EHS_FB_FUNCTION_ENTRY(EHS_FB_DTV_PVR_PLAY_SET_NAME, DtvPvrPlay1_set)
EHS_FB_FUNCTION_ENTRY(EHS_FB_DTV_PVR_PLAY_GET_NAME, DtvPvrPlay1_get)
EHS_FB_FUNCTION_ENTRY(EHS_FB_DTV_PVR_PLAY_PLAY_NAME, DtvPvrPlay1_play)
EHS_FB_FUNCTION_ENTRY(EHS_FB_DTV_PVR_PLAY_PAUSE_NAME, DtvPvrPlay1_pause)
EHS_FB_FUNCTION_ENTRY(EHS_FB_DTV_PVR_PLAY_REV_NAME, DtvPvrPlay1_rev)
EHS_FB_FUNCTION_ENTRY(EHS_FB_DTV_PVR_PLAY_FASTER_NAME, DtvPvrPlay1_faster)
EHS_FB_FUNCTION_ENTRY(EHS_FB_DTV_PVR_PLAY_SLOWER_NAME, DtvPvrPlay1_slower)
EHS_FB_FUNCTION_ENTRY(EHS_FB_DTV_PVR_PLAY_STOP_NAME, DtvPvrPlay1_stop)
EHS_FB_FUNCTION_ENTRY(EHS_FB_DTV_PVR_PLAY_END_NAME, DtvPvrPlay1_end)
