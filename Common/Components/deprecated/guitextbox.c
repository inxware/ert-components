...
EHS_FB_FUNCTION_ENTRY("create", gui_text_create)
EHS_FB_FUNCTION_ENTRY("destroy", gui_text_destroy)
EHS_FB_FUNCTION_ENTRY("show", gui_text_show)
EHS_FB_FUNCTION_ENTRY("hide", gui_text_hide)
EHS_FB_FUNCTION_ENTRY("update", gui_text_string_update)
...
EHS_FB_FUNCTION_ENTRY("show", gui_text_show)
EHS_FB_FUNCTION_ENTRY("hide", gui_text_hide)
EHS_FB_FUNCTION_ENTRY("update", gui_text_float_update)
EHS_FB_FUNCTIONS_END
#endif
...
EHS_FB_FUNCTION_ENTRY("show", gui_text_show)
EHS_FB_FUNCTION_ENTRY("hide", gui_text_hide)
EHS_FB_FUNCTION_ENTRY("update", gui_text_int_update)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("show", gui_text_show)
EHS_FB_FUNCTION_ENTRY("hide", gui_text_hide)
EHS_FB_FUNCTION_ENTRY("update", gui_text_bool_update)
EHS_FB_FUNCTIONS_END
