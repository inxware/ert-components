<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <Hashes>
        <NameHash_CRC16>0xADD5</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>2ed4fda1</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
    ...
    <Functions>
        <Function>
            <name>CreateGUI_WriteTextBoxReal</name>
            <ID>
                <ERT1_ID>1</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>DestroyGUI_WriteTextBoxReal</name>
            <ID>
                <ERT1_ID>2</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>RunGUI_WriteTextBoxReal</name>
            <ID>
                <ERT1_ID>3</ERT1_ID>
            </ID>
        </Function>
