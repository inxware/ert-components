...
EHS_FB_FUNCTION_ENTRY("Run_ConstantInt", ConstantInt)
...
EHS_FB_FUNCTION_ENTRY("Run_ConstantString", ConstantString)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_ConstantBool", ConstantBool)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_ConstantReal", ConstantFloat)
EHS_FB_FUNCTIONS_END
