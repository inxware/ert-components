...
#define INX_sd_select_ARG_slot        1   /* Input: slot number (select)              */
#define INX_sd_select_ARG_error_id    1   /* Output: error code                       */
#define INX_sd_select_ARG_active_slot 1   /* Output: active_slot (read_active)        */
...
EHS_FB_RUN_FUNCTION(sd_select_read_active)
{
    ...
    EHS_FB_OUT_I_API2(2, rc); /* error_id on arg2 for read_active */
