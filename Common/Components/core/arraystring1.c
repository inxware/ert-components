...
EHS_FB_FUNCTION_ENTRY("Run_ArrayStringRead", ArrayStringRead1)
EHS_FB_FUNCTION_ENTRY("Run_ArrayStringWrite", ArrayStringWrite1)
EHS_FB_FUNCTION_ENTRY("Run_ArrayStringClear", ArrayStringClear1)
...
EHS_FB_RUN_FUNCTION(ArrayStringRead1)
{
	...
	if (!arrayString->arrayData) {
		...
		//printf("read index=[%d] - range %d - outport=%x, \ntring=%s\n",index,arrayString->arraySize,NCAPSA_szOut(0),arrayString->arrayData[index]);
...
//		printf("write=[%s],index=[%d]\n",arrayString->arrayData[index],index);
	}
	return;
}
...
EHS_FB_FUNCTION_ENTRY("Run_ArrayIntRead", ArrayIntRead1)
EHS_FB_FUNCTION_ENTRY("Run_ArrayIntWrite", ArrayIntWrite1)
EHS_FB_FUNCTION_ENTRY("Run_ArrayIntClear", ArrayIntClear1)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_ArrayBoolRead", ArrayBoolRead1)
EHS_FB_FUNCTION_ENTRY("Run_ArrayBoolWrite", ArrayBoolWrite1)
EHS_FB_FUNCTION_ENTRY("Run_ArrayBoolClear", ArrayBoolClear1)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_ArrayRealRead", ArrayRealRead1)
EHS_FB_FUNCTION_ENTRY("Run_ArrayRealWrite", ArrayRealWrite1)
EHS_FB_FUNCTION_ENTRY("Run_ArrayRealClear", ArrayRealClear1)
EHS_FB_FUNCTIONS_END
