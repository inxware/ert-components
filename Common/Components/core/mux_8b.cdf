<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <CDFInfo>
        ...
        <UpdatedDate>2024-05-31T12:22:23Z</UpdatedDate>
    </CDFInfo>
    <Description>
        <ShortDescription/>
        <LongDescription>This is a 8-input boolean multiplexer.</LongDescription>
        <UserName/>
        <Menu>
            Data Utilities
            <Menu>
    ...
    <FBID>
        <ERT1_ID>1</ERT1_ID>
        <Class>MultiplexEightInputBool</Class>
    </FBID>
    <Hashes>
        <NameHash_CRC16>0x2751</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>edf94aff</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters/>
    <Functions>
