...
EHS_FB_FUNCTION_ENTRY("Run_OnEntry1Event", 0x01, SFCBarGroup1Event)

EHS_FB_FUNCTION_ENTRY("Run_CL1Event", 0x02, Run_CLEvent)
...
EHS_FB_FUNCTION_ENTRY("Run_OnEntry2Event", 0x01, SFCBarGroup2Event)
...
EHS_FB_FUNCTION_ENTRY("Run_OnEntry3Event", 0x01, SFCBarGroup3Event)
...
EHS_FB_FUNCTION_ENTRY("Run_OnEntry4Event", 0x01, SFCBarGroup4Event)
...
EHS_FB_FUNCTION_ENTRY("Run_CL4Event", 0x05, Run_CLEvent)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_OnEntry8Event", 0x01, SFCBarGroup8Event)
...
EHS_FB_FUNCTION_ENTRY("Run_CL5Event", 0x06, Run_CLEvent)

EHS_FB_FUNCTION_ENTRY("Run_CL6Event", 0x07, Run_CLEvent)

EHS_FB_FUNCTION_ENTRY("Run_CL7Event", 0x08, Run_CLEvent)

EHS_FB_FUNCTION_ENTRY("Run_CL8Event", 0x09, Run_CLEvent)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_OnEntry12Event", 0x01, SFCBarGroup12Event)
...
EHS_FB_FUNCTION_ENTRY("Run_CL9Event", 0x0A, Run_CLEvent)

EHS_FB_FUNCTION_ENTRY("Run_CL10Event", 0x0B, Run_CLEvent)

EHS_FB_FUNCTION_ENTRY("Run_CL11Event", 0x0C, Run_CLEvent)

EHS_FB_FUNCTION_ENTRY("Run_CL12Event", 0x0D, Run_CLEvent)
EHS_FB_FUNCTIONS_END
