...
EHS_FB_FUNCTION_ENTRY("Run_ResetEventCounter", EventCounterVersatile1_Reset)
EHS_FB_FUNCTION_ENTRY("Run_CountEventCounter", EventCounterVersatile1_Count)
EHS_FB_FUNCTION_ENTRY("Run_DecrementEventCounter", EventCounterVersatile1_Decrement)
EHS_FB_FUNCTION_ENTRY("Run_StartEventCounter", EventCounterVersatile1_Enable)
EHS_FB_FUNCTION_ENTRY("Run_StopEventCounter", EventCounterVersatile1_Disable)
...
/*
	printf("bEnableAtInit=[%d]\n",pEventCounterObj->bEnableAtInit);
	printf("nInitialValue=[%d]\n",pEventCounterObj->nInitialValue);
	printf("nStepSize=[%d]\n",pEventCounterObj->nStepSize);
	printf("nMaxThreshold=[%d]\n",pEventCounterObj->nMaxThreshold);
	printf("nMinThreshold=[%d]\n",pEventCounterObj->nMinThreshold);
*/
	if (bRet) {
...
//printf("par nMaxThreshold=[%d]\n",nMaxThreshold);

		nMinThreshold = pEventCounterObj->nMinThreshold;
//printf("par nMinThreshold=[%d]\n",nMinThreshold);
