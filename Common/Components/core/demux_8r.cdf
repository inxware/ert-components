<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <CDFInfo>
        ...
        <UpdatedDate>2024-05-31T09:15:48Z</UpdatedDate>
    </CDFInfo>
    <Description>
        <ShortDescription/>
        <LongDescription>This is a 8-output real demultiplexer.</LongDescription>
        <UserName/>
        <Menu>
            Data Utilities
            <Menu>
    ...
    <FBID>
        <ERT1_ID>1</ERT1_ID>
        <Class>DemultiplexEightOutputReal</Class>
    </FBID>
    <Hashes>
        <NameHash_CRC16>0x2FD9</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>3e33d844</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters/>
    <Functions>
