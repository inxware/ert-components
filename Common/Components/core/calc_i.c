...
EHS_FB_FUNCTION_ENTRY("run", ICalc)
EHS_FB_FUNCTIONS_END
EHS_FB_FUNCTIONS_START(ICalc_1)
EHS_FB_FUNCTION_ENTRY("run", ICalc_1)
EHS_FB_FUNCTIONS_END
EHS_FB_FUNCTIONS_START(ICalc_2)
EHS_FB_FUNCTION_ENTRY("run", ICalc_2)
EHS_FB_FUNCTIONS_END
EHS_FB_FUNCTIONS_START(ICalc_4)
EHS_FB_FUNCTION_ENTRY("run", ICalc_4)
EHS_FB_FUNCTIONS_END
EHS_FB_FUNCTIONS_START(ICalc_6)
EHS_FB_FUNCTION_ENTRY("run", ICalc_6)
EHS_FB_FUNCTIONS_END
EHS_FB_FUNCTIONS_START(ICalc_8)
EHS_FB_FUNCTION_ENTRY("run", ICalc_8)
EHS_FB_FUNCTIONS_END
