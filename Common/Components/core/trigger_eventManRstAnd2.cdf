...
<Component>
  <Class>EventTwoInputManRstAnd</Class>
  <Block>
    <Type>And_Event</Type>
  ...
  <LongDescription>This is a 2-input event AND with an external manual reset. It is asserted once and will not fire again until manually reset.</LongDescription>
  <Port>
