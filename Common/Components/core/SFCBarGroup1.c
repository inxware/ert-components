...
EHS_FB_FUNCTION_ENTRY("Run_OnEntry1", 0x01, SFCBarGroup1)

EHS_FB_FUNCTION_ENTRY("Run_CL1", 0x02, Run_CL)
...
EHS_FB_FUNCTION_ENTRY("Run_OnEntry2", 0x01, SFCBarGroup2)

EHS_FB_FUNCTION_ENTRY("Run_CL1", 0x02, Run_CL)

EHS_FB_FUNCTION_ENTRY("Run_CL2", 0x03, Run_CL)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_OnEntry3", 0x01, SFCBarGroup3)

EHS_FB_FUNCTION_ENTRY("Run_CL1", 0x02, Run_CL)

EHS_FB_FUNCTION_ENTRY("Run_CL2", 0x03, Run_CL)

EHS_FB_FUNCTION_ENTRY("Run_CL3", 0x04, Run_CL)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_OnEntry4", 0x01, SFCBarGroup4)
...
EHS_FB_FUNCTION_ENTRY("Run_CL4", 0x05, Run_CL)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_OnEntry8", 0x01, SFCBarGroup8)
...
EHS_FB_FUNCTION_ENTRY("Run_CL5", 0x06, Run_CL)

EHS_FB_FUNCTION_ENTRY("Run_CL6", 0x07, Run_CL)

EHS_FB_FUNCTION_ENTRY("Run_CL7", 0x08, Run_CL)

EHS_FB_FUNCTION_ENTRY("Run_CL8", 0x09, Run_CL)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_OnEntry12", 0x01, SFCBarGroup12)
...
EHS_FB_FUNCTION_ENTRY("Run_CL9", 0x0A, Run_CL)

EHS_FB_FUNCTION_ENTRY("Run_CL10", 0x0B, Run_CL)

EHS_FB_FUNCTION_ENTRY("Run_CL11", 0x0C, Run_CL)

EHS_FB_FUNCTION_ENTRY("Run_CL12", 0x0D, Run_CL)
EHS_FB_FUNCTIONS_END
