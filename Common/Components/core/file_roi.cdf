<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <Hashes>
        <NameHash_CRC16>0xDA57</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>f94e55ab</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
    ...
    <Functions>
        <Function>
            <name>Run_OpenFILE_ReadOnly_Int</name>
            <ID>
                <ERT1_ID>1</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>Run_CloseFILE_ReadOnly_Int</name>
            <ID>
                <ERT1_ID>2</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>Run_ReadFILE_ReadOnly_Int</name>
            <ID>
                <ERT1_ID>3</ERT1_ID>
            </ID>
        </Function>
