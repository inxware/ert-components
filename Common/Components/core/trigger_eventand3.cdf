...
<Component>
  <Class>EventThreeInputLatchingAnd</Class>
  <Block>
    <Type>And_Event</Type>
  ...
  <LongDescription>This is a 3-input event latching AND with an external reset. Once triggered by receiving all inputs, will trigger on each input received until reset.</LongDescription>
  <Port>
