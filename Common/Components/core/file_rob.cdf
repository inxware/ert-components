<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <Hashes>
        <NameHash_CRC16>0xC7C2</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>80acb28c</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
    ...
    <Functions>
        <Function>
            <name>Run_OpenFILE_ReadOnly_Bool</name>
            <ID>
                <ERT1_ID>1</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>Run_CloseFILE_ReadOnly_Bool</name>
            <ID>
                <ERT1_ID>2</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>Run_ReadFILE_ReadOnly_Bool</name>
            <ID>
                <ERT1_ID>3</ERT1_ID>
            </ID>
        </Function>
