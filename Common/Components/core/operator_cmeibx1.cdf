<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <Description>
        <ShortDescription/>
        <LongDescription>2-input integer comparator.</LongDescription>
        <UserName/>
        <Menu>
            Math
            <Menu>
    ...
    <Hashes>
        <NameHash_CRC16>0x7C85</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>c7336b27</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
