...
<Component>
  ...
  <Port>
    ...
    <FunctionName argument="0">Run_OnEntry3</FunctionName>
  </Port>
  <Port>
    <PortType>StartPort</PortType>
  ...
  <Port>
    ...
    <FunctionName argument="1">Run_OnEntry3</FunctionName>
  </Port>
  <Port>
    <DataType>B</DataType>
    <PortType>InputPort</PortType>
    ...
    <FunctionName argument="2">Run_OnEntry3</FunctionName>
  </Port>
  <Port>
    <DataType>B</DataType>
    <PortType>InputPort</PortType>
    ...
    <FunctionName argument="3">Run_OnEntry3</FunctionName>
  </Port>
  <Port>
    ...
    <FunctionName argument="4">Run_OnEntry3</FunctionName>
  </Port>
  <Port>
    <PortType>FinishPort</PortType>
    <XCoordinate>150</XCoordinate>
    ...
    <FunctionName argument="5">Run_OnEntry3</FunctionName>
  </Port>
  <Port>
    <PortType>FinishPort</PortType>
    <XCoordinate>245</XCoordinate>
    ...
    <FunctionName argument="6">Run_OnEntry3</FunctionName>
  </Port>
</Component>
