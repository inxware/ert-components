<?xml version="1.0" encoding="UTF-8"?><Component>
  ...
  The index must fall between 0 and the maximum size -1. No Error is generated for out of range indices.</LongDescription>
    ...
    <Hashes>
        <NameHash_CRC16>0x2BC8</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>785859e3</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
    ...
    <Functions>
        <Function>
            <name>Run_ArrayRealClear</name>
            <ID>
                <ERT1_ID>1</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>Run_ArrayRealWrite</name>
            <ID>
                <ERT1_ID>2</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>Run_ArrayRealRead</name>
            <ID>
                <ERT1_ID>3</ERT1_ID>
            </ID>
        </Function>
