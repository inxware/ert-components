...
EHS_FB_FUNCTION_ENTRY("getstat", 0x00, runtimeinfo_updatestatic)

EHS_FB_FUNCTION_ENTRY("getdyn", 0x01, runtimeinfo_updatedynamic)

EHS_FB_FUNCTION_ENTRY("reqpairid", 0x02, runtimeinfo_request_pairing_id)
