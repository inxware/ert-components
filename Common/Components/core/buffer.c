...
EHS_FB_FUNCTION_ENTRY("Run_PushFIFOInt", 0x00, PushFIFOInt)

EHS_FB_FUNCTION_ENTRY("Run_PopFIFOInt", 0x01, PopFIFOInt)

EHS_FB_FUNCTION_ENTRY("Run_FlushFIFOInt", 0x02, FlushAnyBuffer)
...
EHS_FB_FUNCTION_ENTRY("Run_PushFIFOReal", 0x00, PushFIFOReal)

EHS_FB_FUNCTION_ENTRY("Run_PopFIFOReal", 0x01, PopFIFOReal)

EHS_FB_FUNCTION_ENTRY("Run_FlushFIFOReal", 0x02, FlushAnyBuffer)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_PushFIFOBool", 0x00, PushFIFOBool)

EHS_FB_FUNCTION_ENTRY("Run_PopFIFOBool", 0x01, PopFIFOBool)

EHS_FB_FUNCTION_ENTRY("Run_FlushFIFOBool", 0x02, FlushAnyBuffer)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_PushFIFOString", 0x00, PushFIFOString)

EHS_FB_FUNCTION_ENTRY("Run_PopFIFOString", 0x01, PopFIFOString)

EHS_FB_FUNCTION_ENTRY("Run_FlushFIFOString", 0x02, FlushAnyBuffer)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_PushLIFOInt", 0x00, PushLIFOInt)

EHS_FB_FUNCTION_ENTRY("Run_PopLIFOInt", 0x01, PopLIFOInt)

EHS_FB_FUNCTION_ENTRY("Run_FlushLIFOInt", 0x02, FlushAnyLIFOBuffer)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_PushLIFOReal", 0x00, PushLIFOReal)

EHS_FB_FUNCTION_ENTRY("Run_PopLIFOReal", 0x01, PopLIFOReal)

EHS_FB_FUNCTION_ENTRY("Run_FlushLIFOReal", 0x02, FlushAnyLIFOBuffer)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_PushLIFOBool", 0x00, PushLIFOBool)

EHS_FB_FUNCTION_ENTRY("Run_PopLIFOBool", 0x01, PopLIFOBool)

EHS_FB_FUNCTION_ENTRY("Run_FlushLIFOBool", 0x02, FlushAnyLIFOBuffer)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_PushLIFOString", 0x00, PushLIFOString)

EHS_FB_FUNCTION_ENTRY("Run_PopLIFOString", 0x01, PopLIFOString)

EHS_FB_FUNCTION_ENTRY("Run_FlushLIFOString", 0x02, FlushAnyLIFOBuffer)
EHS_FB_FUNCTIONS_END
