 ...
 * please see types.h.
 *
 * Lucid project stage two - NcapsaLtd - March 2005 - SDG
*/
...
EHS_FB_FUNCTION_ENTRY("Run_PushFIFOInt", PushFIFOInt)
EHS_FB_FUNCTION_ENTRY("Run_PopFIFOInt", PopFIFOInt)
EHS_FB_FUNCTION_ENTRY("Run_FlushFIFOInt", FlushAnyBuffer)
...
EHS_FB_RUN_FUNCTION(PushFIFOInt)
{
	...
	if (nCurrentUsage < nSize)
	{
		...
		//printf("push=[%d],index=[%d]\n",pContents[nPushIndex],nPushIndex);
...
EHS_FB_FUNCTION_ENTRY("Run_PushFIFOReal", PushFIFOReal)
EHS_FB_FUNCTION_ENTRY("Run_PopFIFOReal", PopFIFOReal)
EHS_FB_FUNCTION_ENTRY("Run_FlushFIFOReal", FlushAnyBuffer)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_PushFIFOBool", PushFIFOBool)
EHS_FB_FUNCTION_ENTRY("Run_PopFIFOBool", PopFIFOBool)
EHS_FB_FUNCTION_ENTRY("Run_FlushFIFOBool", FlushAnyBuffer)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_PushFIFOString", PushFIFOString)
EHS_FB_FUNCTION_ENTRY("Run_PopFIFOString", PopFIFOString)
EHS_FB_FUNCTION_ENTRY("Run_FlushFIFOString", FlushAnyBuffer)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_PushLIFOInt", PushLIFOInt)
EHS_FB_FUNCTION_ENTRY("Run_PopLIFOInt", PopLIFOInt)
EHS_FB_FUNCTION_ENTRY("Run_FlushLIFOInt", FlushAnyLIFOBuffer)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_PushLIFOReal", PushLIFOReal)
EHS_FB_FUNCTION_ENTRY("Run_PopLIFOReal", PopLIFOReal)
EHS_FB_FUNCTION_ENTRY("Run_FlushLIFOReal", FlushAnyLIFOBuffer)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_PushLIFOBool", PushLIFOBool)
EHS_FB_FUNCTION_ENTRY("Run_PopLIFOBool", PopLIFOBool)
EHS_FB_FUNCTION_ENTRY("Run_FlushLIFOBool", FlushAnyLIFOBuffer)
EHS_FB_FUNCTIONS_END
...
EHS_FB_FUNCTION_ENTRY("Run_PushLIFOString", PushLIFOString)
EHS_FB_FUNCTION_ENTRY("Run_PopLIFOString", PopLIFOString)
EHS_FB_FUNCTION_ENTRY("Run_FlushLIFOString", FlushAnyLIFOBuffer)
EHS_FB_FUNCTIONS_END
