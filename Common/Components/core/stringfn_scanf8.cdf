...
<Component>
  ...
  <LongDescription>This is an 8-field string parser. Use the format property to identify the string sections using scanf formatting.</LongDescription>
  <Parameter>
    <Name>Format</Name>
    <DataType>S</DataType>
