<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <CDFInfo>
        ...
        <UpdatedDate>2024-05-31T09:15:45Z</UpdatedDate>
    </CDFInfo>
    <Description>
        <ShortDescription/>
        <LongDescription>This is a 8-output integer demultiplexer.</LongDescription>
        <UserName/>
        <Menu>
            Data Utilities
            <Menu>
    ...
    <FBID>
        <ERT1_ID>1</ERT1_ID>
        <Class>DemultiplexEightOutputInt</Class>
    </FBID>
    <Hashes>
        <NameHash_CRC16>0xA1B0</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>3f6b1d69</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters/>
    <Functions>
