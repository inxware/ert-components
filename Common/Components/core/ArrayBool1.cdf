<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <Description>
        <ShortDescription/>
        <LongDescription>Arrays of boolean variables can be stored in the component. The index must fall between 0 and the maximum size -1. No Error is generated for out of range indices.</LongDescription>
        <UserName/>
        <Menu>
            Data Utilities
            <Menu>
    ...
    <Hashes>
        <NameHash_CRC16>0xF36B</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>a9c2a86c</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
    ...
    <Functions>
        <Function>
            <name>Run_ArrayBoolClear</name>
            <ID>
                <ERT1_ID>1</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>Run_ArrayBoolWrite</name>
            <ID>
                <ERT1_ID>2</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>Run_ArrayBoolRead</name>
            <ID>
                <ERT1_ID>3</ERT1_ID>
            </ID>
        </Function>
