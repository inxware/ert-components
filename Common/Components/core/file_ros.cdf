<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <Parameters>
        ...
        <Parameter>
            ...
            <MinValue>0</MinValue>
            <MaxValue>0</MaxValue>
            <Description>Use the form (x) where x is the delimiter</Description>
    ...
    <Functions>
        <Function>
            <name>Run_OpenFILE_ReadOnly_String</name>
            <ID>
                <ERT1_ID>1</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>Run_CloseFILE_ReadOnly_String</name>
            <ID>
                <ERT1_ID>2</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>Run_ReadFILE_ReadOnly_String</name>
            <ID>
                <ERT1_ID>3</ERT1_ID>
            </ID>
        </Function>
