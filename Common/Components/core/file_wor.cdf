<?xml version="1.0" encoding="UTF-8"?><Component>
 ...
 for a new line) then then this will be used inserted between data points. If a Fixed width parameter is specified then this specifies the length of the ascii format data for the value prepended with zeros. The append option specified if the file is truncated to an empty file when opened or new data is appended to existing data.</LongDescription>
    ...
    <Hashes>
        <NameHash_CRC16>0x4871</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>2c1005a5</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
    ...
    <Functions>
        <Function>
            <name>Run_OpenFILE_WriteOnly_Real</name>
            <ID>
                <ERT1_ID>1</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>Run_CloseFILE_WriteOnly_Real</name>
            <ID>
                <ERT1_ID>2</ERT1_ID>
            </ID>
        </Function>
        <Function>
            <name>Run_WriteFILE_WriteOnly_Real</name>
            <ID>
                <ERT1_ID>3</ERT1_ID>
            </ID>
        </Function>
