<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <Description>
        <ShortDescription/>
        <LongDescription> Not currently available </LongDescription>
        <UserName/>
        <Menu>
            Networking
            <Menu>Data Utilities
			<Menu>database</Menu></Menu>
        </Menu>
    </Description>
    <Block>
        <Type>IO</Type>
    ...
    <Hashes>
        <NameHash_CRC16>0x0469</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>174278c1</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
