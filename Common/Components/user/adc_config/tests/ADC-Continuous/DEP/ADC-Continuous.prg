...
EndOfValues
EndOfLabels
The number of bits that the resulting integer shifted left. Minimum 0.

parameter
decimation	1	1	1000000000	0	0	0	0	1.2	1000
EndOfValues
EndOfLabels
The ADC Decimation number. This means dividing the sampling frequency by this parameter. Minimum 1.

parameter
decimate_average	1	1	1000000000	0	0	0	0	1.2	1000
EndOfValues
EndOfLabels
...
1	1	coords= 985 -308 0	0	0	1	mandatory= 0	0	1
mean
...
1	1	coords= 985 -298 0	1	0	1	mandatory= 0	0	1
var.
...
1	1	coords= 985 -288 0	2	0	1	mandatory= 0	0	1
M.S.
...
2	2	coords= 909 -263 0	0	0	0	mandatory= 0	0	1
enable
...
2	2	coords= 909 -248 0	1	0	0	mandatory= 0	0	1
disable
...
3	2	coords= 985 -318 0	0	0	1	mandatory= 0	0	1
--
...
3	1	coords= 985 -278 0	1	0	1	mandatory= 0	0	1
error
...
3	1	coords= 985 -263 0	2	0	1	mandatory= 0	0	1
--
...
3	1	coords= 985 -248 0	3	0	1	mandatory= 0	0	1
--
