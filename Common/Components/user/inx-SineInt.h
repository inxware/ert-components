...
EHS_GLOBAL EHS_FB_IDENTIFY_FUNCTION(SineInt); // this relates to C file identify function
EHS_GLOBAL EHS_FB_INIT_FUNCTION(SineInt); // this relates to C-file init function
EHS_GLOBAL EHS_FB_DESTROY_FUNCTION(SineInt); //this relates to C-file destroy function
EHS_GLOBAL EHS_FB_RUN_FUNCTION(SineInt_calc); //a function executed by a start port
