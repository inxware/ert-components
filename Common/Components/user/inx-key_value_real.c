...
typedef struct inx_key_value_real_state
{
    ehs_char* domain;
    ehs_char* key;
    ehs_float default_value;
} inx_key_value_real_state_type; //Reference this, maybe store your config parameters in here too.
//ICB STATE VAR MACRO END -- DO NOT ALTER
//ICB POPULATE EHS DATA STRUCTURE MACRO START -- DO NOT ALTER
/* Populate the data structure used by EHS and map the function names to strings identified in CDF */
EHS_FB_FUNCTIONS_START(key_value_real)
EHS_FB_FUNCTION_ENTRY("upsert", 0x01, key_value_real_upsert)
EHS_FB_FUNCTION_ENTRY("query", 0x02, key_value_real_query)
EHS_FB_FUNCTIONS_END
//ICB POPULATE EHS DATA STRUCTURE MACRO END -- DO NOT ALTER
//ICB FRIENDLY LABELS MACRO START -- DO NOT ALTER
/* Friendly labels for the run function data and event function argument enumerations */
#define INX_key_value_real_ARG_upsert_value_in 1
#define INX_key_value_real_ARG_upsert_err_no 1
#define INX_key_value_real_ARG_upsert_set_done 1
#define INX_key_value_real_ARG_query_value_out 1
#define INX_key_value_real_ARG_query_query_errno 2
#define INX_key_value_real_ARG_query_get_done 1
//ICB FRIENDLY LABELS MACRO END -- DO NOT ALTER
//ICB PARAMETER DEFAULTS MACRO START -- DO NOT ALTER
/* Parameters */
/* Create some macros for the default parameters */
#define INX_FB_key_value_real_domain "default"
#define INX_FB_key_value_real_key "default"
#define INX_FB_key_value_real_default_value 0
//ICB PARAMETER DEFAULTS MACRO END -- DO NOT ALTER
#define INX_FB_key_value_real_domain_ext ".js"
#define INX_FB_key_value_real_buf_size_unit 32
 ...
 */
EHS_FB_IDENTIFY_FUNCTION(key_value_real)
{
...
/*
    ...
    ehs_char* key;
    ehs_float default_value;
    EhsSscanf(EHS_FB_IDENTIFY_PARAMETERS,"%s %s %f",&domain,&key,&default_value); */
    EHS_FB_IDENTIFY_MEMORY = sizeof(inx_key_value_real_state_type);
}
//ICB IDENTIFY FUNCTION MACRO START -- DO NOT ALTER
...
EHS_FB_INIT_FUNCTION(key_value_real)
{
    //
    ehs_uint8 i = 0;
    ...
    inx_key_value_real_state_type* inx_key_value_real_state = (inx_key_value_real_state_type*)EHS_FB_INIT_CONTEXT;
...
jump_point:
        if (str_count > 0)
        {
            ...
            if (temp_param[i] != NULL)
            {
                ...
                if (i == 0)
                {
                    EhsStrcat(temp_param[i], INX_FB_key_value_real_domain_ext);
                    str_count += EhsStrlen(INX_FB_key_value_real_domain_ext);
                }
    ...
    inx_key_value_real_state->domain = (ehs_char *) temp_param[0];
    inx_key_value_real_state->key = (ehs_char *) temp_param[1];
    pFbInitParam = EhsGetDoubleFromString(&(inx_key_value_real_state->default_value), pFbInitParam);
...
/**
 * Definition of key_value_real_upsert.
 * [User's info entered in ICB added here]
 * This function can access the object data shared using the following macros:
 *  EHS_FB_RUN_CONTEXT - pointer to the context area for this function block
 *  EHS_FB_RUN_CONTEXT_REF - pointer to the address of the context area for this function block
 */
EHS_FB_RUN_FUNCTION(key_value_real_upsert)
{
    ...
    ehs_char value[32]; /* "%.17lg" can emit ~24 chars + NUL - 22 overflowed */
    ehs_FILE *fp = NULL;
    ...
    if (EHS_FB_IN_CONNECTED_API2(INX_key_value_real_ARG_upsert_value_in))
        value_temp = EHS_FB_IN_F_API2(INX_key_value_real_ARG_upsert_value_in) ;
    EhsSprintf(value, "%.17lg", value_temp);
    if (domain == NULL)
        fp = openKeyValuePairFile(INX_FB_key_value_real_domain INX_FB_key_value_real_domain_ext);
    else
    {
