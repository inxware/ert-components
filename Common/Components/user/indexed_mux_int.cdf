<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <CDFInfo>
        ...
        <UpdatedDate>2024-08-09T11:11:49Z</UpdatedDate>
    </CDFInfo>
    <Description>
        <ShortDescription>Multiplex the integer inputs according to the index.</ShortDescription>
        <LongDescription>Multiplex the integer inputs according to the index.</LongDescription>
        <UserName/>
        <Menu>
            Data Utilities
            <Menu>
    ...
    <FBID>
        <ERT1_ID>1</ERT1_ID>
        <Class>indexed_mux_int</Class>
    </FBID>
    <Hashes>
        <NameHash_CRC16>0x7F70</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>4053483c</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
