...
EHS_FB_FUNCTION_ENTRY("open", netsocketsrvr_open)
EHS_FB_FUNCTION_ENTRY("close", netsocketsrvr_close)
EHS_FB_FUNCTION_ENTRY("sendData", netsocketsrvr_sendData)
//EHS_FB_FUNCTION_ENTRY("receiveData", netsocketsrvr_receiveData)
