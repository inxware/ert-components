...
EHS_FB_FUNCTION_ENTRY("create", unity2_create)
EHS_FB_FUNCTION_ENTRY("destroy", unity2_destroy)
EHS_FB_FUNCTION_ENTRY("setmedia", unity2_setmedia)
EHS_FB_FUNCTION_ENTRY("stop", unity2_stop)
...
EHS_UNITY_EXPORT ehs_bool EhsUnityWritePoll(void **buffer, size_t *length){
	...
	if(success==EHS_FALSE){
		*length=0;
		//EHSH_LOG_INFO("EhsUnityWritePoll fifo empty");
	}else{
