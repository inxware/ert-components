...
EHS_FB_FUNCTION_ENTRY("LoadScript", html_java_LoadScript)
EHS_FB_FUNCTION_ENTRY("RunFunction", html_java_RunFunction)
EHS_FB_FUNCTION_ENTRY("UnLoadAll", html_java_UnLoadAll)
EHS_FB_FUNCTION_ENTRY("setVisibile", html_java_setVisibile)
EHS_FB_FUNCTION_ENTRY("setInvisible", html_java_setInvisible)
