...
EHS_COMPONENT_API_EXPORT EHS_FB_IDENTIFY_FUNCTION(TanInt); // this relates to C file identify function
EHS_COMPONENT_API_EXPORT EHS_FB_INIT_FUNCTION(TanInt); // this relates to C-file init function
EHS_COMPONENT_API_EXPORT EHS_FB_DESTROY_FUNCTION(TanInt); //this relates to C-file destroy function
EHS_COMPONENT_API_EXPORT EHS_FB_RUN_FUNCTION(TanInt_calc); //a function executed by a start port
