...
EHS_FB_FUNCTION_ENTRY("getList", application_info_getter_getList)
EHS_FB_FUNCTION_ENTRY("getInfo", application_info_getter_getInfo)
EHS_FB_FUNCTION_ENTRY("setDefault", application_info_getter_setDefault)
EHS_FB_FUNCTION_ENTRY("deleteApp", application_info_getter_deleteApp)
EHS_FB_FUNCTION_ENTRY("getDefault", application_info_getter_getDefault)
