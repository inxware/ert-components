<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <CDFInfo>
        <Version>3</Version>
        <CreationDate>2024-09-25T12:29:37Z</CreationDate>
        <UpdatedDate>2024-09-25T12:39:11Z</UpdatedDate>
    </CDFInfo>
    <Description>
        <ShortDescription>Parse the boolean values from json string input or file.</ShortDescription>
        <LongDescription>Parse the boolean values from json string input or file.</LongDescription>
        <UserName/>
        <Menu>
            Data Utilities
            <Menu>
    ...
    <FBID>
        <ERT1_ID>1</ERT1_ID>
        <Class>json_parser_bool</Class>
    </FBID>
    <Hashes>
        <NameHash_CRC16>0xB7DB</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>41b50f43</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
