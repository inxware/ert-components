<?xml version="1.0" encoding="UTF-8"?><Component>
    ...
    <CDFInfo>
        <Version>3</Version>
        <CreationDate>2024-09-25T12:33:35Z</CreationDate>
        <UpdatedDate>2024-09-26T10:37:05Z</UpdatedDate>
    </CDFInfo>
    <Description>
        <ShortDescription>Parse the float numbers from json string input or file.</ShortDescription>
        <LongDescription>Parse the float numbers from json string input or file.</LongDescription>
        <UserName/>
        <Menu>
            Data Utilities
            <Menu>
    ...
    <FBID>
        <ERT1_ID>1</ERT1_ID>
        <Class>json_parser_real</Class>
    </FBID>
    <Hashes>
        <NameHash_CRC16>0x15FB</NameHash_CRC16>
        <FbApiDescriptorHash_CRC32>4e9ebcd3</FbApiDescriptorHash_CRC32>
        <FbApiDescriptorHash/>
    </Hashes>
    <Parameters>
        <Parameter>
