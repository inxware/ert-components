...
/* todo we should have  this overridden for different tarets? */
    ...
    {
        EhsHLogger_setLogLevel("Undefined", EHSH_LOG_LEVEL_INFO | EHSH_LOG_LEVEL_WARNING | EHSH_LOG_LEVEL_ERROR | EHSH_LOG_LEVEL_ENTER | EHSH_LOG_LEVEL_EXIT);
        EhsHLogger_setLogLevel("Kernel", EHSH_LOG_LEVEL_INFO | EHSH_LOG_LEVEL_WARNING | EHSH_LOG_LEVEL_ERROR | EHSH_LOG_LEVEL_ENTER | EHSH_LOG_LEVEL_EXIT);
        EhsHLogger_setLogLevel("Graphics",  EHSH_LOG_LEVEL_INFO | EHSH_LOG_LEVEL_WARNING | EHSH_LOG_LEVEL_ERROR | EHSH_LOG_LEVEL_ENTER | EHSH_LOG_LEVEL_EXIT);
        EhsHLogger_setLogLevel("Logger",  EHSH_LOG_LEVEL_INFO | EHSH_LOG_LEVEL_WARNING | EHSH_LOG_LEVEL_ERROR | EHSH_LOG_LEVEL_ENTER | EHSH_LOG_LEVEL_EXIT);
        EhsHLogger_setLogLevel("HalMemory",  EHSH_LOG_LEVEL_INFO | EHSH_LOG_LEVEL_WARNING | EHSH_LOG_LEVEL_ERROR | EHSH_LOG_LEVEL_ENTER | EHSH_LOG_LEVEL_EXIT);
        EhsHLogger_setLogLevel("HalProcess", EHSH_LOG_LEVEL_INFO | EHSH_LOG_LEVEL_WARNING | EHSH_LOG_LEVEL_ERROR | EHSH_LOG_LEVEL_ENTER | EHSH_LOG_LEVEL_EXIT);
        EhsHLogger_setLogLevel("HalString", EHSH_LOG_LEVEL_INFO | EHSH_LOG_LEVEL_WARNING | EHSH_LOG_LEVEL_ERROR | EHSH_LOG_LEVEL_ENTER | EHSH_LOG_LEVEL_EXIT);
        EhsHLogger_setLogLevel("TgtViewport", EHSH_LOG_LEVEL_INFO | EHSH_LOG_LEVEL_WARNING | EHSH_LOG_LEVEL_ERROR | EHSH_LOG_LEVEL_ENTER | EHSH_LOG_LEVEL_EXIT);
        EhsHLogger_setLogLevel("Network",EHSH_LOG_LEVEL_INFO | EHSH_LOG_LEVEL_WARNING | EHSH_LOG_LEVEL_ERROR | EHSH_LOG_LEVEL_ENTER | EHSH_LOG_LEVEL_EXIT);
        EhsHLogger_setLogLevel("Devman", EHSH_LOG_LEVEL_INFO | EHSH_LOG_LEVEL_WARNING | EHSH_LOG_LEVEL_ERROR | EHSH_LOG_LEVEL_ENTER | EHSH_LOG_LEVEL_EXIT);
        EhsHLogger_setLogLevel("file", EHSH_LOG_LEVEL_INFO | EHSH_LOG_LEVEL_WARNING | EHSH_LOG_LEVEL_ERROR | EHSH_LOG_LEVEL_ENTER | EHSH_LOG_LEVEL_EXIT);
    }
#else
    // Not verbose mode...
    void EhsHSetLogLevels()
